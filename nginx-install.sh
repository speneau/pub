...
echo "server {listen 80;listen [::]:80;root /var/www/web.sebpno.ga/html;index index.html index.htm index.nginx-debian.html;server_name web.sebpno.ga;location /{ try_files \$uri \$uri/ =404;}} " | sudo tee -a /etc/nginx/sites-available/web.sebpno.ga
